...
#e.g. Ecoli_MG1655
Query_species = str(sys.argv[2])
#e.g. Ecoli_B_BL21_DE3
Sbjct_species = DB_tobe_searched_against = str(sys.argv[3])

#name of that uniprot xml that to be used as query---xml(query)
Filename_xml_query = str(sys.argv[4])  # e.g. "uniprot-proteome_UP000000625_Ecoli_k12_MG1655.xml"
Filename_xml_sbjct = str(sys.argv[5])  # e.g. "uniprot-proteome_UP000002032_Ecoli_B_BL21_DE3.xml"

search_length = int(sys.argv[6])
